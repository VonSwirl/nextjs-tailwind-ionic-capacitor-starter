...
export const lists = [
	...
	},
	{
		...
		id: "hardware",
		items: [
			{ name: "Circular Saw", done: false },
			{ name: "Tack Cloth", done: false },
			{ name: "Drywall", done: false },
			{ name: "Router", done: false },
		],
	},
	{
		name: "Work",
